...
import {Flex, Grid, GridItem, Heading, HStack, Img, SimpleGrid, Text} from "@chakra-ui/react";
    ...
    return (
        <DefaultLayout>
            ...
            <Flex my={12} mx={["1rem","18rem"]} direction="column" justify="center" align="center">
                <Text mb={12} textAlign="center" color="#5d21db" fontWeight={700} fontSize={["14pt","20pt"]}>
            ...
            <Flex textAlign={["center", "left"]} position={"relative"} direction="column" justify="center" align="center" px={[5,12]} py={["10rem",12]} bg="#f3f4f6">
                <Img left={["1rem","7rem"]} top={20} position={["absolute"]} src={"/images/molecule_gray-small.png"}/>
                <Img right={10} top={[-5, -20]} position={"absolute"} src={"/images/baby_red.png"}/>
                <Img right={10} bottom={20} position={"absolute"} src={"/images/molecule_green.png"}/>
                <Img left={[10]} bottom={["-4rem","-10rem"]} position={"absolute"} w={["12rem","15rem"]} src={"/images/molecule_gray.png"}/>
                <RubberBand>
                ...
                <SimpleGrid mx={["0rem","6rem"]} px={["0rem","5rem"]} py={12} columns={[1,2]} spacing={[5]}>
                    <Text color="#42829e" fontSize="14pt">
                        ...
                        enfermedades
                        infecciosas en todo el mundo,</UnderlinedText> y aunque con frecuencia se piensa que la etapa de
                        vacunación
                        sucede solo en la niñez, no es así, <UnderlinedText>existe una vacuna para cada etapa de la
                        vida.</UnderlinedText>
                    </Text>
                    <Text color="#42829e" fontSize="14pt">
                        Por esta razón, <UnderlinedText>queremos informar, a profesionales de la salud y a la población,
                        acerca de las
                        vacunas, enfermedades,</UnderlinedText> centros de salud y calendario de vacunas para tomar
                        control de ellas,
                        prevenir y protegernos entre todos.
                    </Text>
                </SimpleGrid>
            </Flex>

            <Flex position={"relative"} mb={"10rem"} px={[3,12]} py={12} direction="column" justify="center" align="center">
                <Img display={["none", "block"]} bottom={"-10rem"} left={"6rem"} position={"absolute"} src={"/images/girl_purple.png"}/>
                <Heading my={12} textAlign="center" px={["1rem","18rem"]} color="#02adfd" fontWeight="600" size="lg">
                    Te presentamos articulos sobre vacunación y sus
                    beneficios para la salud.
                </Heading>

                <Grid mx={["1rem","12rem"]} gap={[0,5]} rowGap={[6,0]} templateColumns={["repeat(1, 1fr)","repeat(5, 1fr)"]}>
                    <GridItem colSpan={2}>
                        <CardArticle
